		...
		if (Technology == "4G")
		{
			...
			switch (ObjectType)
			{
				...
				//Object Selection (Governorate Band)
					...
					{
						//Select the Governorate Band Random
						String PLMNxddNum = general.randomNumberToSelectFDDorTDD
						if (PLMNxddNum == '1')
						{
							WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Object-Type/TopX Object Types/TopX Regions XDD/TopX FDD'))
		...
		switch (ResolutionTemp)
		{
			...
			case 'Hourly' :
				...
				if (activeProfile == "ZainNetCell")
				{
					...
					WebUI.delay(1)
					WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/End-date/BeforeArrow'))
					WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/End-date/NextDate'))
					...
					WebUI.delay(1)
					WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/StartDate/Curent date'))
					WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/TopX/TopXDate/Button OK'))
				}
				else
				{
			...
			case 'Daily' :
				...
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Resolution Temp Daily'))
			...
			case 'Raw' :
				...
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Select Resolution temp'))
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Resolution Temp Raw'))
			...
			case 'DailyBH' :
				...
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Select Resolution temp'))
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Resolution Temp DailyBH'))
			...
			case 'WeeklyBH' :
				...
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Select Resolution temp'))
				WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Resolution Temp/Resolution Temp WeeklyBH'))
