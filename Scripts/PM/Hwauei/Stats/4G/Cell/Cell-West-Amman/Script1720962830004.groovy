...
CustomKeywords.'PMHwaueiStats.Stats'("4G","Site", true, "Hourly")
/*
WebUI.callTestCase(findTestCase('LoginNew'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/PM/Huawei-vendor/Object-Type/Object-Type-Selection/Cell/West-Amman-Option1-E'))
